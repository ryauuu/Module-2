...
class Creature:
    ...
    def __str__(self) -> str:
        return f"Существо {self.name}, вид {self.species}"
...
class WarmBlooded(Creature):
    ...
    def __str__(self) -> str:
        return f"Теплокровное {self.name}, вид {self.species}, цвет шерсти {self.fur_color}"

class WingedCreature(Creature):
    ...
    def __str__(self) -> str:
        return f"Крылатое Существо {self.name}, вид {self.species}, размах крыльев {self.wing_span} м"
